<template>
    ...
    <section>
        <div class="container">
            ...
            <div class="col-md-6 align-self-center">
                <h1>404</h1>
                <h2>OH OH! Vous êtes perdus.</h2>
                <p>La page que vous recherchez n'existe pas. Comment vous êtes arrivé ici est un mystère. Mais vous pouvez cliquer sur le menu ci-dessus pour revenir à la page d'accueil.
                </p>
            </div>
            </div>
        </div>
